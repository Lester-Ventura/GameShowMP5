...
public class loginPage extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // Start processing the username and set the attribute, also a check if the user accessed this servlet
             ...
             if(request.getParameter("username")!=null){
                 ...
                 session.setAttribute("currentUser",request.getParameter("username"));
                 request.getRequestDispatcher("QuestionsBanker").forward(request,response);}
                    }
